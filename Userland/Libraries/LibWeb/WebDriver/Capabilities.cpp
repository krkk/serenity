...
static JsonValue match_capabilities(JsonObject const& capabilities)
{
    ...
    auto result = capabilities.try_for_each_member([&](auto const& name, auto const& value) -> ErrorOr<void> {
        ...
        if (name == "browserName"sv) {
            ...
            if (value.as_deprecated_string() != matched_capabilities.get_deprecated_string(name).value())
        ...
        // -> "browserVersion"
            ...
            if (!matches_browser_version(value.as_deprecated_string(), matched_capabilities.get_deprecated_string(name).value()))
        ...
        // -> "platformName"
            ...
            if (!matches_platform_name(value.as_deprecated_string(), matched_capabilities.get_deprecated_string(name).value()))
