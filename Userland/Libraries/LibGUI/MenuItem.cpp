...
void MenuItem::update_window_server()
{
    ...
    case MenuItem::Type::Submenu: {
        ...
        ConnectionToWindowServer::the().async_update_menu_item(m_menu_id, m_identifier, submenu.menu_id(), submenu.name().to_byte_string(), m_enabled, m_visible, false, false, m_default, ""sv, icon);
        break;
    }
    default:
        VERIFY_NOT_REACHED();
