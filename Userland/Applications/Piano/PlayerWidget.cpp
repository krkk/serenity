...
ErrorOr<void> PlayerWidget::initialize()
{
    ...
    TRY(m_track_number_choices.try_append("1"_short_string));
...
void PlayerWidget::add_track()
{
    ...
    auto latest_track_string = String::number(latest_track_count).release_value_but_fixme_should_propagate_errors();
